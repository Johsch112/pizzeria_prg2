...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1838373708924447097, ; hash 0x19833725ecdbe979, from name: libaot-pizzeria_prg2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 39
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4877524845665848164, ; hash 0x43b07301410e0b64, from name: pizzeria_prg2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 119
	...
	%struct.DSOCacheEntry {
		i64 5768301344037349560, ; hash 0x500d1f82b8c128b8, from name: aot-pizzeria_prg2
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 8313009801844162844, ; hash 0x735dbe5edd43011c, from name: libaot-pizzeria_prg2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 199
	...
	%struct.DSOCacheEntry {
		i64 10917487336910096174, ; hash 0x9782b4e3bc5a072e, from name: aot-pizzeria_prg2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 273
	...
	%struct.DSOCacheEntry {
		i64 15672222980357462968, ; hash 0xd97eebc400eb9bb8, from name: pizzeria_prg2.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-pizzeria_prg2.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7600b10f-5004-496d-82c2-78c2a5096cf5\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [22 x i8] c"com.pizza.pizzeriaprg\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [28 x i8] c"libaot-pizzeria_prg2.dll.so\00", align 16
